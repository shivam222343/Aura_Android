...
module.exports = (io, socket) => {
    ...
    socket.on('games:host', async (data) => {
        ...
        const chaoticMessages = [
            ...
            `Is it a bird? Is it a plane? No, it's ${userName}'s terrible drawing! Come see! 🤣🎨`,
            `EMERGENCY: ${userName} has a brush and isn't afraid to use it badly! 🖌️🆘`,
            `🤫 ${userName} started a game. This is our chance to steal all the points! 🏃‍♂️💨`,
            ...
            `First one to join ${userName}'s game gets a "Not a Chicken" award! 🐔❌`,
            `The board is on fire! Or is that just ${userName}'s attempt at a sun? ☀️🔥`,
            `I've seen better drawings on a napkin, but ${userName} is trying! Come laugh! 🤷‍♂️😂`,
            `Ready for takeoff? ${userName}'s game is starting. Don't be left behind! 🛰️🌠`,
            `The circus is in town and ${userName} is the lead artist! Grab popcorn! 🍿🤡`,
            `Oh no! ${userName} is drawing again. Someone please save the canvas! 🆘🎨`,
            `Flash sale: 100% discount on boredom if you join ${userName}'s game! 💸🎮`,
            ...
            `Action! ${userName}'s game is live. Show off your 200 IQ and win! 🧠🏆`,
            `We have virtual cookies in ${userName}'s game! (Not really, but we have fun!) 🍪🎮`,
            `ATTENTION: ${userName} is looking for victims... I mean, players! 😈🎨`,
            `Don't let ${userName}'s game sink! Jump in and start guessing! 🌊🚣‍♂️`,
            ...
            `Life is a rollercoaster, and ${userName}'s game is the loop! Get in! 🎢🕹️`,
            `Unidentified Drawing Object! ${userName} is at it again. Can you ID it? 🛸👽`,
            `Your throne awaits in ${userName}'s game. Don't keep the host waiting! 👑🎮`,
            `If this was a party, there'd be pizza. But it's better: ${userName}'s game! 🍕🎉`,
            `A storm is brewing! It's the "${userName} drawing" hurricane! 🌪️🌀`,
            `${userName}'s game is a hidden gem. Come and polish your guessing skills! 💎✨`,
            `${userName} is performing magic! Making prompts disappear with bad art! 🪄🤣`,
            `Ding ding! Round 1 of ${userName}'s game is about to start. Get in the ring! 🥊🎮`,
            `Lost in ${userName}'s drawing? You're not alone. Join the search party! 🗺️🕵️‍♂️`,
            `Boom! ${userName}'s game is explosive! Don't miss the blast! 🧨💥`,
            `Stay cool and join ${userName}'s game. It's the chillest spot right now! 🧊🆒`,
            ...
            `Beam me up, ${userName}! The game is starting and we need more brains! 🛸🧠`,
            ...
            `Level up your day! ${userName}'s game is the power-up you need! 🍄🆙`,
            `The mothership has landed. All aliens report to ${userName}'s lobby! 🛸👽`
        ];
